...
function validateInputs(activityName, gradeValue) {
    if(activityName === '' || gradeValue === '') {
        ...
        return 'Nota precisa ser um número entre 0 e 10.';
...
function statusImg(num) {
    if(num >= minGrade) {
        return '<img src="./images/aprovado.png" alt="emoji com chapéu de comemoração" role="img" aria-label="Aprovado">';
    } else {
        return '<img src="./images/reprovado.png" alt="emoji triste" role="img" aria-label="Reprovado">';
    }
}
